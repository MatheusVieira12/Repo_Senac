...
df_mar = pl.read_csv('marco.csv', separator= ';', encoding='latin1')
df_abr = pl.read_csv('abri.csv', separator= ';', encoding='latin1')
df_mai = pl.read_csv('mai.csv', separator= ';', encoding='latin1')
df_jun = pl.read_csv('jun.csv', separator= ';', encoding='latin1')
df_jul = pl.read_csv('julho.csv', separator= ';', encoding='latin1')
